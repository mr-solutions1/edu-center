...
const LandingPage = () => {
  ...
  const handleApply = (e) => {
    ...
    toast.success(
      'تم إرسال طلبك بنجاح! سيتواصل معك مستشار التعليم الخاص بمعهدنا خلال دقائق.'
    );
  ...
  return (
    <div
      className="min-h-screen bg-slate-50 text-right text-slate-800 font-sans selection:bg-secondary/30"
      dir="rtl"
    >
      {/* Top Contact Bar */}
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Button
              size="xs"
              variant="ghost"
              className="text-white hover:text-secondary text-[11px] font-black"
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <img
              src={logoAlpha}
              alt="Alpha Academy"
              className="h-12 w-12 rounded-xl object-cover shadow-sm bg-primary/5 p-0.5"
            />
            <div>
              <h1 className="text-base font-black tracking-tight text-primary leading-tight">
                Edu Center ERP
              </h1>
          ...
          <nav className="hidden lg:flex items-center gap-8 font-black text-xs text-slate-600">
            ...
            <a href="#apply" className="hover:text-secondary transition-colors">
              تقديم طلب جديد
            </a>
          </nav>
      ...
      <section
        id="hero"
        className="relative py-20 lg:py-32 bg-gradient-to-b from-white to-transparent overflow-hidden"
      >
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-sm text-slate-500 leading-relaxed font-medium">
              هل تبحث عن مدرس خصوصي موثوق يؤسس ابنك في المواد الأساسية أو يدعمه
              في المراحل المتقدمة؟ نحن نوفر نخبة من أفضل المدرسين لجميع المواد
              ولجميع المراحل الدراسية وبأسعار مناسبة للجميع في الكويت.
            </p>

            <div className="flex flex-wrap gap-4 pt-4">
              <Button
                onClick={() => navigate('/login')}
                className="rounded-2xl px-6 py-5 font-black text-xs shadow-xl shadow-primary/10"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <h2 className="text-2xl lg:text-3xl font-black text-primary">
              أكاديمية ركان للتدريس الخصوصي
            </h2>
            <p className="text-sm text-slate-500 leading-relaxed font-medium">
              أكاديمية ركان هي مؤسسة تعليمية كويتية متخصصة في تقديم خدمات
              التدريس الخصوصي لجميع المراحل الدراسية من التأسيس إلى الجامعة. نضم
              نخبة من أفضل المدرسين والمدرسات المؤهلين لتقديم تعليم متميز وفق
              أحدث الأساليب التعليمية.
            </p>
            <p className="text-sm text-slate-500 leading-relaxed font-medium">
              نؤمن بأن كل طالب يستحق تعليماً يراعي احتياجاته الفردية، ولهذا نقدم
              خططاً دراسية مخصصة تناسب مستوى كل طالب وتساعده على تحقيق أقصى
              استفادة ممكنة.
            </p>
      ...
      <section id="services" className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 space-y-12">
          <div className="text-center space-y-4 max-w-xl mx-auto">
            ...
            <h2 className="text-2xl lg:text-3xl font-black text-primary">
              نقدم حلولاً تعليمية متكاملة تغطي جميع المراحل الدراسية
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="shadow-md border-none hover:shadow-xl transition-shadow rounded-3xl overflow-hidden bg-white">
              ...
              <CardContent className="p-5 text-xs text-slate-500 font-medium leading-relaxed space-y-2">
                <p>
                  تدريس جميع مواد الصفوف المتوسطة مع متابعة دورية واختبارات
                  تقييمية مستمرة قياسية.
                </p>
                <ul className="space-y-1 text-slate-700 font-bold pt-2">
            ...
            <Card className="shadow-md border-none hover:shadow-xl transition-shadow rounded-3xl overflow-hidden bg-white">
              ...
              <CardContent className="p-5 text-xs text-slate-500 font-medium leading-relaxed space-y-2">
                <p>
                  تدريس جميع مواد الصفوف الثانوية (علمي وأدبي) مع التركيز الكامل
                  على الامتحانات النهائية.
                </p>
                <ul className="space-y-1 text-slate-700 font-bold pt-2">
            ...
            <Card className="shadow-md border-none hover:shadow-xl transition-shadow rounded-3xl overflow-hidden bg-white">
              ...
              <CardContent className="p-5 text-xs text-slate-500 font-medium leading-relaxed space-y-2">
                <p>
                  تدريس مواد الكليات الهندسية والإدارية والعلوم والتطبيقية
                  والتدريبية التخصصية.
                </p>
                <ul className="space-y-1 text-slate-700 font-bold pt-2">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-12">
          <div className="text-center space-y-4 max-w-xl mx-auto">
            <h3 className="text-xs font-black text-secondary uppercase tracking-widest">
              بوابات الدخول الموحدة
            </h3>
            <h2 className="text-2xl lg:text-3xl font-black">
              اختر بوابتك للدخول إلى نظام المعهد الموحد
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-white/5 border border-white/10 hover:border-secondary/40 transition-all rounded-3xl p-6 text-right flex flex-col justify-between space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-primary-foreground/60 leading-relaxed font-bold">
                  متابعة جدول الحصص والدرجات والتقييمات والاختبارات والمستندات
                  والتفاعل المباشر مع الذكاء الاصطناعي الخاص بك.
                </p>
              </div>
              <Button
                onClick={() => navigate('/login')}
                className="w-full rounded-xl bg-secondary text-secondary-foreground font-black text-xs hover:bg-secondary/90 shadow-lg shadow-secondary/20 py-5"
              >
                دخول الطالب
              </Button>
            </Card>
            ...
            <Card className="bg-white/5 border border-white/10 hover:border-secondary/40 transition-all rounded-3xl p-6 text-right flex flex-col justify-between space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-primary-foreground/60 leading-relaxed font-bold">
                  متابعة مستوى الأبناء وتقارير الحضور والغياب والدرجات وتفاصيل
                  الفواتير والمدفوعات المتأخرة وصندوق الرسائل الموحد.
                </p>
              </div>
              <Button
                onClick={() => navigate('/login')}
            ...
            <Card className="bg-white/5 border border-white/10 hover:border-secondary/40 transition-all rounded-3xl p-6 text-right flex flex-col justify-between space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-primary-foreground/60 leading-relaxed font-bold">
                  رصد وتحضير الحصص والغياب وتدريس المناهج وتحميل المستندات
                  والمتابعة المالية وحصص الطلاب.
                </p>
              </div>
              <Button
                onClick={() => navigate('/login')}
      ...
      <section id="faq" className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 space-y-12">
          <div className="text-center space-y-4">
            ...
            <h2 className="text-2xl lg:text-3xl font-black text-primary">
              إجابات لأكثر الأسئلة التي تهم أولياء الأمور والطلاب
            </h2>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-5 border rounded-2xl bg-slate-50/50 space-y-2">
              ...
              <p className="text-xs text-slate-500 leading-relaxed pl-6 font-bold">
                نقدم خيارين للتدريس: حضوري (في المعهد أو منزل الطالب) وعن بُعد
                (عبر منصات تفاعلية متطورة). يتم تحديد الجدول بالاتفاق مع ولي
                الأمر، ونوفر تقارير أداء دورية مستمرة.
              </p>
            </div>
            ...
            <div className="p-5 border rounded-2xl bg-slate-50/50 space-y-2">
              ...
              <p className="text-xs text-slate-500 leading-relaxed pl-6 font-bold">
                نقوم بتقييم مستوى الطالب أولاً، ثم نختار المدرس الأنسب من حيث
                التخصص والخبرة وأسلوب التدريس المعتمد. يمكنك طلب تغيير المدرس في
                أي وقت إذا لزم الأمر.
              </p>
            </div>
            ...
            <div className="p-5 border rounded-2xl bg-slate-50/50 space-y-2">
              ...
              <p className="text-xs text-slate-500 leading-relaxed pl-6 font-bold">
                نعم، نوفر حصة تجريبية مجانية بالكامل دون أي التزام. يمكنك تجربة
                المعلم وطريقة الشرح قبل إتمام الاشتراك في أي باقة شهرية.
              </p>
            </div>
          </div>
        </div>
          ...
          <Card className="shadow-xl rounded-3xl border-none p-8 bg-white text-right space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-[11px] text-slate-400 font-bold">
                احجز حصة تجريبية مجانية وسيتواصل معك مستشارو المعهد فوراً
              </p>
            </div>
            ...
            <form onSubmit={handleApply} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full rounded-2xl bg-secondary hover:bg-secondary/90 text-secondary-foreground font-black text-xs py-5 mt-2"
              >
      ...
      <footer className="bg-primary text-primary-foreground py-12 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-[11px] text-primary-foreground/60 leading-relaxed font-bold">
              نحو تعليم أفضل لمستقبل مشرق. نقدم حلولاً تكنولوجية وتعليمية متميزة
              لجميع المراحل الدراسية لضمان التفوق وتحقيق الأهداف.
            </p>
          </div>

          <div className="space-y-3 text-xs">
            <h4 className="font-black text-white border-r-2 border-secondary pr-2">
              روابط سريعة
            </h4>
          ...
          <div className="space-y-3 text-xs">
            ...
            <ul className="space-y-2 pr-2 text-primary-foreground/75 font-bold">
              ...
              <li dir="ltr" className="text-right font-mono">
                +965 5086 6476
              </li>
        ...
        <div className="max-w-7xl mx-auto px-6 pt-8 mt-8 border-t border-white/5 text-center text-[10px] text-primary-foreground/45 font-black">
          © 2026 أكاديمية ركان. جميع الحقوق محفوظة. نظام إدارة معاهد التعليم
          الموحد.
        </div>
      </footer>
    </div>
