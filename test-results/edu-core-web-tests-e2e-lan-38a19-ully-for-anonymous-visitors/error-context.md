...
- Name: edu-core-web/tests/e2e/landing-page.spec.js >> Landing Page Accessibility >> should render landing page successfully for anonymous visitors
- Location: edu-core-web/tests/e2e/landing-page.spec.js:4:3
...
> 6  |     await page.goto('/');
  ...
  15 |     await expect(page.locator('text=+965 5086 6476')).toBeVisible();
  16 |
